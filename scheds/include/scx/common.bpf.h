...
static inline u64 scx_clock_pelt(u32 cpu)
{
	 ...
	 * explicitly frozen during idle, IRQ, and hypervisor steal. Unlike
	 * scx_clock_task(), there is no stale-read issue for idle CPUs: the
	 * clock simply does not advance during idle by design.
	 */
