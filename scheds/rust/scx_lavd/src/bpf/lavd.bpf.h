...
enum consts_internal {
	...
	LAVD_CPU_CONGESTED_THRES	= 2, /* the CPU is congested when two or more tasks are waiting across its DSQs */
...
extern const volatile u8	lb_ct_mig_delta_pct;
extern const volatile u8	no_ovrflw_extend;
extern const volatile bool	has_multi_cpdom_per_llc;
