...
# TODO (aws): minheap-ATQ
#	- stress-ng -c 64 vs. 64: 100% (not 50%)
# TODO (aws): minheap-ATQ
#	- stress-ng -c 512 vs. 512: task stall at exit.

# -------------
# Test 03-03 (l1, l2): running on three cgroups
# echo $$ > /sys/fs/cgroup/test03_l1/l2-a/cgroup.procs
# echo $$ > /sys/fs/cgroup/test03_l1/l2-b/cgroup.procs
# echo $$ > /sys/fs/cgroup/test03_l1/l2-c/cgroup.procs
#
# TODO (aws)
# 64 vs. 64 vs 64: 150% not 50%
...
#
# GOOD (l1): minheap-ATQ
# XXX TODO (l2, aws): minheap-ATQ: 128 vs. 128 => 150% : 50% (not 100% : 100%)
...
# XXX TODO (l2, aws): minheap-ATQ: 128 vs. 128 => 150% not 50%
...
# XXX TODO (aws): 128 => 4000% not 12800%?
...
#
# TODO (aws, max_match == 3, with lock)
#   - stress-ng -c 110: 110 cpus
#   - stress-ng -c 120: 116 - 120 cpus
#   - stress-ng -c 128: 110 - 120 cpus
#   - stress-ng -c 256: 191 cpus
...
#
# TODO (aws, forced 1 LLC)
#   - stress-ng -c 32: fluctuate
